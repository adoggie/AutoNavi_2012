...
#define  APP_TASK_USB_PRIO			5
#define  APP_TASK_KBD_PRIO			8
#define  APP_TASK_GSM_PRIO			12
#define  APP_TASK_GPS_PRIO			23
#define  APP_TASK_LED_PRIO			10
#define  OS_PROBE_TASK_PRIO		(OS_LOWEST_PRIO - 3)
#define  OS_TASK_TMR_PRIO			(OS_LOWEST_PRIO - 2)

#define  APP_TASK_MAIN_PRIO			9
/*
*********************************************************************************************************
*                                            TASK STACK SIZES
...
#define  APP_TASK_USB_STK_SIZE			256
