...
class WorkTask(models.Model):
	...
	img_st = models.DateTimeField(null=False,db_index=True) #检索影像开始时间
	img_et = models.DateTimeField(null=False,db_index=True) #检索影像结束时间
...
class ImageFile(models.Model):
	...
	checked = models.ForeignKey(AppUser,db_index=True,null=True)			#检查者
	check_time =  models.DateTimeField(null=False,db_index=True,null=True)  #检查时间
	check_passed = models.BooleanField(default=True)						#是否通过检查
	check_comment = models.TextField(null=True)								#检查未通过原因描述
	operator = models.ForeignKey(AppUser,null=True,db_index=True)			#作业员
...
class ImageCheckLog(models.Model):
	...
	checked = models.ForeignKey(AppUser,db_index=True,null=True)
	check_time =  models.DateTimeField(null=False,db_index=True,null=True)  #检查时间
	check_passed = models.BooleanField(default=True)						#是否通过检查
